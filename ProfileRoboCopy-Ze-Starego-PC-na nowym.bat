...
robocopy "b:\users\%username%\AppData\Roaming\Microsoft" "c:\Users\%username%\AppData\Roaming\Microsoft"  /b /fft /r:0  /NDL /E /MIR /ZB /NDL  /XD "Crypto" /XD "HTML Help" /XD "Protect" /XD "Windows" /XD "Outlook" /XD "Internet Explorer"   /xf "desktop.ini"
robocopy "b:\users\%username%\AppData\Roaming\Microsoft\Windows" "c:\Users\%username%\AppData\Roaming\Microsoft\Windows"    /b /fft /r:0  /NDL /E /MIR /ZB /NDL  /XD "Start Menu" /xf "desktop.ini"
