...
shadowspawn.exe "c:\users\%user%" a: robocopy a:\  "b:\%user%" /E /ZB /XA:H /b /fft /r:0  /NDL  /XD "a:\AppData" /XD "a:\Application Data" /XD "a:\Cookies" /XD "a:\Local Settings" /XD "a:\NetHood" /XD "a:\PrintHood" /XD "a:\SendTo" /XD "a:\Start Menu" /XD "a:\Templates" /xf "a:\desktop.ini" /XD "a:\Contacts"/XD "a:\Desktop" /XD "a:\Favorites" /XD "a:\Links" /XD "a:\Documents" /XD "a:\Music" /XD "a:\Pictures" /XD "a:\Videos" /XD "a:\Saved Games" /XD "a:\Searches"
...
shadowspawn.exe "c:\Users\%user%\AppData\Local\Google\Chrome" a: robocopy a:\  "b:\%user%\AppData\Local\Google\Chrome" /E /ZB /XA:H /b /fft /r:0  /NDL  /XD  /xf "a:\hiberfil.sys" /xf "a:\desktop.ini" /XD "a:\Cache"
...
shadowspawn.exe "c:\ProgramData" a: robocopy a:\  "b:\%user%\C\ProgramData" /E /ZB /XA:H /b /fft /r:0  /NDL  /XD "a:\1E" /XD "a:\Application Data" /XD "a:\Desktop" /XD "a:\Documents" /XD "a:\Favorites" /XD "a:\McAfee" /XD "a:\Package Cache" /XD "a:\Start Menu" /XD "a:\System Time" /XD "a:\Templates"  /XD "a:\Microsoft" /xf "a:\desktop.ini"
