...
%~dp0shadowspawn.exe "c:\Users\%username%\AppData\Roaming" a: robocopy a:\  "b:\users\%username%\AppData\Roaming" /E /MIR /ZB /XA:H /b /fft /r:0  /NDL  /XD "a:\McAffee", "a:\Media Center Programs", "a:\Sun", "a:\Microsoft" /xf "a:\desktop.ini"
%~dp0shadowspawn.exe "c:\Users\%username%\AppData\Roaming\Microsoft" a: robocopy a:\  "b:\users\%username%\AppData\Roaming\Microsoft"  /b /fft /r:0  /NDL /E /MIR /ZB /NDL  /XD "a:\Crypto", "a:\HTML Help", "a:\Protect", "a:\Windows", "a:\Internet Explorer", "a:/Outlook" /xf "a:\desktop.ini"
%~dp0shadowspawn.exe "c:\Users\%username%\AppData\Roaming\Microsoft\Windows" a: robocopy a:\  "b:\users\%username%\AppData\Roaming\Microsoft\Windows" /XD "a:\Start Menu" /b /fft /r:0  /NDL /E /MIR /ZB /NDL   /xf "a:\desktop.ini"
del /S /F /Q    "c:\Users\%username%\AppData\Local\Google\Chrome\User Data\Default\Cache\"
%~dp0shadowspawn.exe "c:\Users\%username%\AppData\Local" a: robocopy a:\  "b:\users\%username%\AppData\Local" /E /MIR /ZB /XA:H /b /fft /r:0  /NDL  /XD "a:\Microsoft" /XD  "a:\Temp" /XD "a:\Application Data" /XD "a:\Temporary Internet Files" /XD "a:\Google\Chrome\User Data\Default\Cache" /xf "a:\desktop.ini"
%~dp0shadowspawn.exe "c:\Users\%username%\AppData\Local\Microsoft" a: robocopy a:\  "b:\users\%username%\AppData\Local\Microsoft" /E /MIR /ZB /XA:H /b /fft /r:0  /NDL  /XD "a:\Windows" /xf "a:\desktop.ini"
%~dp0shadowspawn.exe "c:\Users\%username%\AppData\Local\Microsoft\Windows" a: robocopy a:\  "b:\users\%username%\AppData\Local\Microsoft\Windows" /E /MIR /ZB /XA:H /b /fft /r:0  /NDL  /XD "a:\Windows" /XD "a:\Temporary Internet Files"  /xf "a:\desktop.ini"
%~dp0shadowspawn.exe "c:\Users\%username%\AppData\LocalLow" a: robocopy a:\  "b:\users\%username%\AppData\LocalLow" /E /MIR /Z /XA:H /b /fft /r:0  /NDL /xf "a:\desktop.ini"
