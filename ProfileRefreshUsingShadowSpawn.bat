...
%~dp0shadowspawn.exe "c:\Users\%username%\AppData\Roaming\Microsoft" a: robocopy a:\  "b:\users\%username%\AppData\Roaming\Microsoft"  /b /fft /r:0  /NDL /E /MIR /ZB /NDL  /XD "a:\Crypto", "a:\HTML Help", "a:\Protect", "a:\Windows" /xf "a:\desktop.ini"
%~dp0shadowspawn.exe "c:\Users\%username%\AppData\Roaming\Microsoft\Windows" a: robocopy a:\  "b:\users\%username%\AppData\Roaming\Microsoft\Windows"  /b /fft /r:0  /NDL /E /MIR /ZB /NDL   /xf "a:\desktop.ini"
